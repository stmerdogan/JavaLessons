...
public class Lambda01 {
    public static void main(String[] args) {
        ...
        //Allmatch : veri;len sarta gore stream icindeki tum elemanlarin bu sarta uymasi durumunda
        //true verecektir.Bir tane sart bile saglamazsa sonuc false olacaktir.

        //2) Kurs isimlerinden en az birinin "Turkish" icerip icermedigini kontrol eden kodu yaziniz

        boolean result2 = courseList.
                stream().
                anyMatch(t -> t.getCoursName().contains("Turkishx"));
        System.out.println(result2);
        //AnyMatch :  Verilen sarta gore stream icindeki herhangi bir elemanin bu sarta uymasi durumunda true verecektir

        //3) Kurs donemlerinden "Fall" doneminin hic bulunmadigini kontrol eden kodu yaziniz
        ...
        long ingilizceBolumSayisi = courseList.stream().
                filter(t -> t.getCoursName().contains("English")).
                count();
        System.out.println(ingilizceBolumSayisi);

        //9 Ogrenci sayisi 140 tan az olan kurslari bir liste halinde veren kodu yaziniz
        List<Course> myList4 = courseList.stream().
