...
public class E05 {
    public static void main(String[] args) {
        ...
        /*
        1)FileNotFoundException ve IOException Compile Time Exception'lardir,yani code yazzarken hata aliriz
        ...
        istenirse FileNotFoundException yerine  IOException da kullanilir
