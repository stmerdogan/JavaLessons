...
public class NestedIf01 {
    ...
    public static void main(String[] args) {
        ...
        1.Kullanicidan 3 tane sayi aliniz.
        Bu 3 sayinin ucgen olusturma durumunu kontrol ediniz.Eger ucgen ise "eskenar" Ucgen olma durumunu kontrol ediniz.

        INFO :
        Ucgen Olma Sarti: herhangi iki kenar toplami ucuncu kenarda buyuk olmali herhangi iki kenar farki ucuncu kenardan kucuk olmali
