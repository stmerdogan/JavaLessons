...
public class PassByeValue01 {
    ...
    public static void main(String[] args) {
        ...
        //Normalde discount methodu ile indirim yaptik ama deger hala orijinal
        System.out.println(shirtPrice);//100

        shirtPrice = discount("veteran", shirtPrice);
        System.out.println("shirt price kampanya fiyati: " +shirtPrice);//
    }
    //Discount metodunu olusturalim
