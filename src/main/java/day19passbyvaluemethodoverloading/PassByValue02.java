...
public class PassByValue02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(name);//Dr Tom Hanks....Istersek orijinal degeri degistirebiliriz.
        // Ama method call ile yaptigimiz islemde java kopya deger uzerinde manipulasyon yapar
    }
